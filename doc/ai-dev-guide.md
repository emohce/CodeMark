...
- 流程导航：已实现上下步导航（Prev/Next），支持 Alt+Up/Down 快捷键，工具栏按钮和右键菜单
- 流程入口：支持设置 Process 的 entryFilePath 和 entryLine，编辑器 Inlay 显示流程入口提示
...
- 大树性能：懒加载、批量更新、最小重绘
- 快捷键冲突检查与可配置
- 测试补齐：repository、持久化、引用链、UI 交互、流程导航
